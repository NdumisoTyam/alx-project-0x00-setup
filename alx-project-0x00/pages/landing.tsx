  ...
  return (
    <div className="space-y-4 p-6">
      ...
      <div className="space-x-2">
        ...
        <Button title="Small lg" styles="text-sm rounded-lg" /> {/* ✅ Added */}
      </div>
      ...
      <div className="space-x-2">
        ...
        <Button title="Medium lg" styles="text-base rounded-lg" /> {/* ✅ Added */}
      </div>
      ...
      <div className="space-x-2">
        ...
        <Button title="Large lg" styles="text-lg rounded-lg" /> {/* ✅ Added */}
      </div>
    </div>
  );
};
